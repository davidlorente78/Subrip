...
namespace ReferenceIndexCreator
{
    ...
    /// </summary>
    public class HSKBooklet_Generator_A4_Vertical_OneCharacterPerPage_Acumulative
    {
        ...
        public HSKBooklet_Generator_A4_Vertical_OneCharacterPerPage_Acumulative(int Level)
        {
            ...
            for (int x = 1; x <= Level ; x++)
            {
                ...
                //Asi sera 1,12, 123, 1234 Y se añadira a la salida de los ficheros para formar parte del path
            }
        ...
        public void DocumentGenerator()
        {
            ...
            PdfWriter writer = new PdfWriter(@"D:\\HSKBooklet\" + pathLevel + "_HSK.pdf");
        ...
        public void AddCaracterPage(string c, PdfDocument pdf, Document document, string sIndex)
        {
            ...
            string path = @"D:\HSKBooklet\Chars\" + sIndex + "_" + c.ToString() + ".png";
        ...
        private void SaveBitmapfromFontChar(string c, string FontName, FontStyle fontStyle, string sIndex)
        {
            ...
            bitmapchar.Save(@"D:\HSKBooklet\Chars\" + sIndex + "_" + c.ToString() + ".png", ImageFormat.Png);
